...
import com.example.android.talonsparkouradventure.Game.Game.Game;
...
public class TitleScreen extends AppCompatActivity {
    ...
    // EFFECTS: starts Game / starts the game
    public void playGameButton (View view) {

        startActivity(new Intent(TitleScreen.this, Game.class));
